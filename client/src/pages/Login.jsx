    ...
    >
      ...
      >
        <h2 className="text-3xl font-semibold text-white text-center mb-3">
          {state === "Sign Up" ? "Create your " : "Login"}
        </h2>
        ...
        { state === 'Sign Up' ? (
            <p className="text-center text-xs text-gray-400 mt-4">Already  have an account ?{' '}
           
           <span onClick={()=> setState('Login')} className="text-blue-400 cursor-pointer underline">Login here</span>
        </p>
        ) : (
            <p className="text-center text-xs text-gray-400 mt-4">Don't  have an account ?{' '}
